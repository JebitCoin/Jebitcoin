...
uint256 hashGenesisBlock("0x00000626d16cf8bfe683224cdd04c1bee1edbf6e04b940f1f70329b23b7b47d3");
...
// Launch specs
static const int64 nTargetTimespan = 10 * 60 * 60; // Jebitcoin: each block
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000a8a0165329f0154c1dbc92ac79334ea962ee3ab76bd69b2cc02f9a46f1a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        // Genesis block
        const char* pszTimestamp = "Official Chinese Currency Renminbi to Become Cryptocurrency, Expert Says";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1555640646;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 345237;

        if (fTestNet)
        {
            block.nTime    = 1555640708;
            block.nNonce   = 123647;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x9efd6c72b2cb27430b6b690fa98797dbf1347fca537d3564f3ac36aa1cde9acc"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd5, 0xa1, 0xf7, 0xc2 }; 
